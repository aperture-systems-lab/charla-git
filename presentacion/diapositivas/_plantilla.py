...
Reglas:
  ...
  * No añadas fondo: ``SlideBase.iniciar_slide`` pone el grafo decorativo y va
    rotando el preset en cada diapositiva.
  * Nunca hardcodees colores: úsalos desde ``estilo``. Y respeta los roles:
    cian la rama principal, morado la rama de trabajo, ámbar el staging,
    verde lo confirmado, rojo lo que falla.
